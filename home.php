                ...
                <div class="input-group searchbox">
                    <div class="input-group-btn">
                        <center><a href="include/find_friends.php"><button class="btn btn-default 
                            search-icon" name="search_box" type="submit">Add new user</button></a></center>
                    </div>
                </div>
                <div class="left-chat">
                    <ul>
            ...
            <div class="col-md-9 col-sm-9 col-xs-12 right-sidebar">
                        ...
                        <div class="right-header-detail">
                            ...
                            <?php 
                                if(isset($_POST['logout'])){
                                    $upsate_msg = mysqli_query($con, "UPDATE users SET log_in='Offline'
                ...
                <div class="row">
                    <div class="col-md-12 right-chat-textbox">
                        <form method="post">
                            <input type="text" id="msg_content" name="msg_content" placeholder="Write your message.....">
